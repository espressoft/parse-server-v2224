...
// Added by CS Soon
    _logger2.default.warn('COUNT: ', count);
    _logger2.default.warn('ISMASTER ', isMaster);
/*
          if (count) {
          }
          else
          if (Object.keys(query).length === 0) {
            throw new _node.Parse.Error(_node.Parse.Error.INVALID_KEY_NAME, 'Restricted Query');
          }
*/
        if (!query) {
          if (op == 'get') {
